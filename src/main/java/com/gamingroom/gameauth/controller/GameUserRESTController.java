...
@Path("/gameusers") // FIXME: Add path annotation for gameusers 
...
public class GameUserRESTController {
    ...
    @RolesAllowed("USER")  // FIXME: Add RolesAllowed annotation for USER based on BasicAuth Security Example 
    @GET
    @Path("/{id}")
    ...
    @RolesAllowed("ADMIN") // FIXME: Add RolesAllowed annotation for ADMIN based on BasicAuth Security Example 
    @POST
    ...
    @RolesAllowed("ADMIN")//added this seems like an admin thing to do
    @PUT
    @Path("/{id}")
